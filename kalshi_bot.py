                ...
                async with websockets.connect(
                    ...
                    async for raw in ws:
                        ...
                        if mtype == "ticker":
                            ...
                            yes_ask = msg.get("yes_ask_dollars", 0) or 0
                            yes_bid = msg.get("yes_bid_dollars", 0) or 0
                            # Rough liquidity proxy: ask × open_interest if available
                            liquidity = float(msg.get("liquidity", 0) or 0)
